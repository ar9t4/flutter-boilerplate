...
import 'package:flutter_boilerplate/features/feedback/presentation/widgets/feedback_item.dart';
        ...
        children: [
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Text(
                l10n.briefly_describe_feedback,
                style: TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold,
                    color: colorScheme.onSurface),
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                    border: InputBorder.none, hintText: l10n.type_here),
                onChanged: (value) => {
            ...
            child: Column(
              children: [
                if (isInvalid) ...[
                  Column(
                    children: [
                      Text(l10n.submit_feedback_validation_note,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () =>
                        provider.isValid(l10n, focusNode, controller),
                  ),
                ),
              ],
            ),
