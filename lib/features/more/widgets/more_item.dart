...
import 'package:flutter_boilerplate/features/more/models/more.dart';
...
class MoreItem extends BaseStatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      key: Key(more.id.toString()),
      dense: true,
      leading: more.icon,
      title: Text(more.name, style: const TextStyle(fontSize: 14)),
      trailing: more.name == localization.version
          ? _buildVersion()
